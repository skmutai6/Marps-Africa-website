    ...
    <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8 bg-white mt-8 mb-8 rounded-lg font-['Roboto']">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-6 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-[#37B6FF] font-['Poppins']">
            Let’s level up your project, together
          </h2>
          <p className="text-gray-600 font-['Roboto']">
            You can reach us via email, <a href="mailto:marpsafrica@gmail.com" className="text-[#37B6FF]">marpsafrica@gmail.com</a>
          </p>
          ...
          <div className="mt-6 relative">
            ...
            <a
              ...
              className="absolute top-2 right-2 flex items-center bg-white p-2 rounded-lg shadow-lg text-[#37B6FF] hover:text-blue-800 font-semibold text-xs md:text-sm transition-colors"
            >
        ...
        <div className="p-6 bg-gray-50 rounded-lg font-['Roboto']">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="ml-auto block px-6 py-3 bg-[#37B6FF] text-white font-extrabold rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 font-inter text-sm md:text-base"
            >
              {isSubmitting ? (
